...
const projects = [
  {
    ...
    category: 'Frontend',
    title: 'Gym Website',
    description: 'A gym website developed with Next offers a modern and responsive user experience, leveraging the power of Next component-based architecture',
